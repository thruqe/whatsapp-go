...
- **Package Layout**:
  ...
  - `whatsrook/cmd`: WhatsApp bot CLI application, plugin commands (`cli/plugins`), and consolidated CLI feature utilities (`cli/utils`: media downloaders, font styling, URL validators, prompts, timezones, Meta AI parsers, games).
