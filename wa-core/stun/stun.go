...
func normalizedParticipantPIDs(participantPIDs []uint32) []uint32 {
	// Source of truth: https://github.com/purpshell/wacaller/blob/99134bb900df3ee83a69d9a38112e623817597ae/datasheets/group-video-reactions.md#L40-L46
...
func createWasmGroupReceiverSubscriptions(participantPIDs []uint32) []byte {
	// Source of truth: https://github.com/purpshell/wacaller/blob/99134bb900df3ee83a69d9a38112e623817597ae/datasheets/group-video-reactions.md#L44-L46
	var out []byte
	for _, pid := range participantPIDs {
		var participant []byte
		participant = pbTag(participant, 1, 0)
