...
// offer. wacaller reads it to choose the per-call audio codec.
//
// This is wacaller-original glue: the whatsapp-rust reference does not parse
...
// a wacaller-specific lever, so the parser carries no // Source of truth: port.
