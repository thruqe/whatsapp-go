...
// Audio in wacaller is 16 kHz mono float32 PCM carried in 60 ms frames — the rate
...
var errSourceClosed = errors.New("wacaller: audio source closed")
...
// CGO Speaker() sink lives in the wacaller/audio/malgo subpackage.
