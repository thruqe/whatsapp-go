-- v19 (compatible with v8+): Only keep the latest MAC for each app state mutation index
...
CREATE TABLE whatsmeow_app_state_mutation_macs_v19 (
	jid       TEXT,
	name      TEXT,
	version   BIGINT,
...
INSERT INTO whatsmeow_app_state_mutation_macs_v19 (jid, name, version, index_mac, value_mac)
...
ALTER TABLE whatsmeow_app_state_mutation_macs_v19 RENAME TO whatsmeow_app_state_mutation_macs;
-- end only sqlite
