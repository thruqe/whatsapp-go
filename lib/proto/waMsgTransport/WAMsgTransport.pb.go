...
func (MessageTransport_Protocol_Ancillary_BackupDirective_ActionType) EnumDescriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 0, 0, 0}
}
...
func (*MessageTransport_Payload) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 0}
}
...
func (*MessageTransport_Protocol) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1}
}
...
func (*MessageTransport_Protocol_Ancillary) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 0}
}
...
func (*MessageTransport_Protocol_Integral) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 1}
}
...
func (*MessageTransport_Protocol_Ancillary_BackupDirective) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 0, 0}
}
...
func (*MessageTransport_Protocol_Ancillary_ICDCParticipantDevices) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 0, 1}
}
...
func (*MessageTransport_Protocol_Ancillary_SenderKeyDistributionMessage) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 0, 2}
}
...
func (*MessageTransport_Protocol_Ancillary_ICDCParticipantDevices_ICDCIdentityListDescription) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 0, 1, 0}
}
...
func (*MessageTransport_Protocol_Integral_DeviceSentMessage) Descriptor() ([]byte, []int) {
	return file_waMsgTransport_WAMsgTransport_proto_rawDescGZIP(), []int{1, 1, 1, 0}
}
...
const file_waMsgTransport_WAMsgTransport_proto_rawDesc = "" +
	"\n" +
	"#waMsgTransport/WAMsgTransport.proto\x12\x0eWAMsgTransport\x1a\x11waAdv/WAAdv.proto\x1a\x17waCommon/WACommon.proto\"\xba\x03\n" +
	...
	"\x12recipientTimestamp\x18\t \x01(\x04R\x12recipientTimestamp\x12.\n" +
	...
	"\x13receiverAccountType\x18\x05 \x01(\x0e2\x18.WAAdv.ADVEncryptionTypeR\x13receiverAccountType\x124\n" +
	"\x13recipientKeyIndexes\x18\n" +
	" \x03(\rB\x02\x10\x01R\x13recipientKeyIndexes\"\x8b\x10\n" +
	...
	"\x05phash\x18\x02 \x01(\tR\x05phashB*Z(go.mau.fi/whatsmeow/proto/waMsgTransport"
...
var file_waMsgTransport_WAMsgTransport_proto_goTypes = []any{
	...
	(*DeviceListMetadata)(nil),                                                                     // 1: WAMsgTransport.DeviceListMetadata
	(*MessageTransport)(nil),                                                                       // 2: WAMsgTransport.MessageTransport
	...
	(waAdv.ADVEncryptionType)(0),                                                                   // 12: WAAdv.ADVEncryptionType
	(*waCommon.SubProtocol)(nil),                                                                   // 13: WACommon.SubProtocol
	(waCommon.FutureProofBehavior)(0),                                                              // 14: WACommon.FutureProofBehavior
}
var file_waMsgTransport_WAMsgTransport_proto_depIdxs = []int32{
	12, // 0: WAMsgTransport.DeviceListMetadata.senderAccountType:type_name -> WAAdv.ADVEncryptionType
	12, // 1: WAMsgTransport.DeviceListMetadata.receiverAccountType:type_name -> WAAdv.ADVEncryptionType
	3,  // 2: WAMsgTransport.MessageTransport.payload:type_name -> WAMsgTransport.MessageTransport.Payload
	4,  // 3: WAMsgTransport.MessageTransport.protocol:type_name -> WAMsgTransport.MessageTransport.Protocol
	13, // 4: WAMsgTransport.MessageTransport.Payload.applicationPayload:type_name -> WACommon.SubProtocol
	14, // 5: WAMsgTransport.MessageTransport.Payload.futureProof:type_name -> WACommon.FutureProofBehavior
	6,  // 6: WAMsgTransport.MessageTransport.Protocol.integral:type_name -> WAMsgTransport.MessageTransport.Protocol.Integral
	5,  // 7: WAMsgTransport.MessageTransport.Protocol.ancillary:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary
	9,  // 8: WAMsgTransport.MessageTransport.Protocol.Ancillary.skdm:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary.SenderKeyDistributionMessage
	1,  // 9: WAMsgTransport.MessageTransport.Protocol.Ancillary.deviceListMetadata:type_name -> WAMsgTransport.DeviceListMetadata
	8,  // 10: WAMsgTransport.MessageTransport.Protocol.Ancillary.icdc:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary.ICDCParticipantDevices
	7,  // 11: WAMsgTransport.MessageTransport.Protocol.Ancillary.backupDirective:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary.BackupDirective
	11, // 12: WAMsgTransport.MessageTransport.Protocol.Integral.DSM:type_name -> WAMsgTransport.MessageTransport.Protocol.Integral.DeviceSentMessage
	0,  // 13: WAMsgTransport.MessageTransport.Protocol.Ancillary.BackupDirective.actionType:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary.BackupDirective.ActionType
	10, // 14: WAMsgTransport.MessageTransport.Protocol.Ancillary.ICDCParticipantDevices.senderIdentity:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary.ICDCParticipantDevices.ICDCIdentityListDescription
	10, // 15: WAMsgTransport.MessageTransport.Protocol.Ancillary.ICDCParticipantDevices.recipientIdentities:type_name -> WAMsgTransport.MessageTransport.Protocol.Ancillary.ICDCParticipantDevices.ICDCIdentityListDescription
