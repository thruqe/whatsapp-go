...
type SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode int32

const (
	SyncActionValue_GroupHistoryToggleAction_GROUP_HISTORY_TOGGLE_MODE_UNKNOWN SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode = 0
	SyncActionValue_GroupHistoryToggleAction_GROUP_HISTORY_TOGGLE_MODE_ON      SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode = 1
	SyncActionValue_GroupHistoryToggleAction_GROUP_HISTORY_TOGGLE_MODE_OFF     SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode = 2
)

// Enum value maps for SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode.
var (
	SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode_name = map[int32]string{
		0: "GROUP_HISTORY_TOGGLE_MODE_UNKNOWN",
		1: "GROUP_HISTORY_TOGGLE_MODE_ON",
		2: "GROUP_HISTORY_TOGGLE_MODE_OFF",
	}
	SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode_value = map[string]int32{
...
func (x SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) Enum() *SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode {
	p := new(SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode)
	*p = x
	return p
}

func (x SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) String() string {
	return protoimpl.X.EnumStringOf(x.Descriptor(), protoreflect.EnumNumber(x))
}

func (SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) Descriptor() protoreflect.EnumDescriptor {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[26].Descriptor()
}

func (SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) Type() protoreflect.EnumType {
	return &file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[26]
}

func (x SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) Number() protoreflect.EnumNumber {
	return protoreflect.EnumNumber(x)
}

// Deprecated: Do not use.
func (x *SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) UnmarshalJSON(b []byte) error {
	num, err := protoimpl.X.UnmarshalJSONEnum(x.Descriptor(), b)
	if err != nil {
		return err
	}
	*x = SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode(num)
	return nil
}

// Deprecated: Use SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode.Descriptor instead.
func (SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode) EnumDescriptor() ([]byte, []int) {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_rawDescGZIP(), []int{80, 4, 0}
}
...
func (WaffleAccountLinkStateAction_AccountLinkState) Descriptor() protoreflect.EnumDescriptor {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[29].Descriptor()
}

func (WaffleAccountLinkStateAction_AccountLinkState) Type() protoreflect.EnumType {
	return &file_waSyncAction_WAWebProtobufSyncAction_proto_enumTypes[29]
}
...
func (x *SyncActionValue) GetGroupHistoryToggleAction() *SyncActionValue_GroupHistoryToggleAction {
	if x != nil {
		return x.GroupHistoryToggleAction
	}
	return nil
}
...
type SyncActionValue_GroupHistoryToggleAction struct {
	state                  protoimpl.MessageState                                           `protogen:"open.v1"`
	GroupHistoryToggleMode *SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode `protobuf:"varint,1,opt,name=groupHistoryToggleMode,enum=WAWebProtobufSyncAction.SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode" json:"groupHistoryToggleMode,omitempty"`
	unknownFields          protoimpl.UnknownFields
	sizeCache              protoimpl.SizeCache
}
...
func (x *SyncActionValue_GroupHistoryToggleAction) String() string {
	return protoimpl.X.MessageStringOf(x)
}
...
// Deprecated: Use SyncActionValue_GroupHistoryToggleAction.ProtoReflect.Descriptor instead.
func (*SyncActionValue_GroupHistoryToggleAction) Descriptor() ([]byte, []int) {
	return file_waSyncAction_WAWebProtobufSyncAction_proto_rawDescGZIP(), []int{80, 4}
}

func (x *SyncActionValue_GroupHistoryToggleAction) GetGroupHistoryToggleMode() SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode {
	if x != nil && x.GroupHistoryToggleMode != nil {
		return *x.GroupHistoryToggleMode
	}
...
const file_waSyncAction_WAWebProtobufSyncAction_proto_rawDesc = "" +
	...
	"\rmodelMetaData\x18\x02 \x01(\tR\rmodelMetaData\"\xf8\x04\n" +
	...
	"\aallowed\x18\x01 \x01(\bR\aallowed\x1a\xb4\x02\n" +
	"\x18GroupHistoryToggleAction\x12\x90\x01\n" +
	"\x16groupHistoryToggleMode\x18\x01 \x01(\x0e2X.WAWebProtobufSyncAction.SyncActionValue.GroupHistoryToggleAction.GroupHistoryToggleModeR\x16groupHistoryToggleMode\"\x84\x01\n" +
...
var file_waSyncAction_WAWebProtobufSyncAction_proto_goTypes = []any{
	...
	(SyncActionValue_GroupHistoryToggleAction_GroupHistoryToggleMode)(0), // 26: WAWebProtobufSyncAction.SyncActionValue.GroupHistoryToggleAction.GroupHistoryToggleMode
	(UsernameChatStartModeAction_ChatStartMode)(0),                       // 27: WAWebProtobufSyncAction.UsernameChatStartModeAction.ChatStartMode
	(WASARootSecretAction_RootSecretEntry_Status)(0),                     // 28: WAWebProtobufSyncAction.WASARootSecretAction.RootSecretEntry.Status
	(WaffleAccountLinkStateAction_AccountLinkState)(0),                   // 29: WAWebProtobufSyncAction.WaffleAccountLinkStateAction.AccountLinkState
	(*AgentAction)(nil),                                                  // 30: WAWebProtobufSyncAction.AgentAction
	(*AiThreadRenameAction)(nil),                                         // 31: WAWebProtobufSyncAction.AiThreadRenameAction
	(*AndroidUnsupportedActions)(nil),                                    // 32: WAWebProtobufSyncAction.AndroidUnsupportedActions
	(*ArchiveChatAction)(nil),                                            // 33: WAWebProtobufSyncAction.ArchiveChatAction
	(*AutoOrganizeBusinessChatSetting)(nil),                              // 34: WAWebProtobufSyncAction.AutoOrganizeBusinessChatSetting
	(*AvatarUpdatedAction)(nil),                                          // 35: WAWebProtobufSyncAction.AvatarUpdatedAction
	(*BizAISettingsNudgeAction)(nil),                                     // 36: WAWebProtobufSyncAction.BizAISettingsNudgeAction
	(*BotWelcomeRequestAction)(nil),                                      // 37: WAWebProtobufSyncAction.BotWelcomeRequestAction
	(*BroadcastListParticipant)(nil),                                     // 38: WAWebProtobufSyncAction.BroadcastListParticipant
	(*BubbleLockMessageAction)(nil),                                      // 39: WAWebProtobufSyncAction.BubbleLockMessageAction
	(*BusinessBroadcastAssociationAction)(nil),                           // 40: WAWebProtobufSyncAction.BusinessBroadcastAssociationAction
	(*BusinessBroadcastCampaignAction)(nil),                              // 41: WAWebProtobufSyncAction.BusinessBroadcastCampaignAction
	...
	(*CallLogAction)(nil),                                                // 44: WAWebProtobufSyncAction.CallLogAction
	(*CallLogRecord)(nil),                                                // 45: WAWebProtobufSyncAction.CallLogRecord
	(*ChatAssignmentAction)(nil),                                         // 46: WAWebProtobufSyncAction.ChatAssignmentAction
	(*ChatAssignmentOpenedStatusAction)(nil),                             // 47: WAWebProtobufSyncAction.ChatAssignmentOpenedStatusAction
	(*ClearChatAction)(nil),                                              // 48: WAWebProtobufSyncAction.ClearChatAction
	(*CoexV2VersionAction)(nil),                                          // 49: WAWebProtobufSyncAction.CoexV2VersionAction
	(*ContactAction)(nil),                                                // 50: WAWebProtobufSyncAction.ContactAction
	(*CtwaPerCustomerDataSharingAction)(nil),                             // 51: WAWebProtobufSyncAction.CtwaPerCustomerDataSharingAction
	(*CustomPaymentMethod)(nil),                                          // 52: WAWebProtobufSyncAction.CustomPaymentMethod
	(*CustomPaymentMethodMetadata)(nil),                                  // 53: WAWebProtobufSyncAction.CustomPaymentMethodMetadata
	(*CustomPaymentMethodsAction)(nil),                                   // 54: WAWebProtobufSyncAction.CustomPaymentMethodsAction
	(*CustomerDataAction)(nil),                                           // 55: WAWebProtobufSyncAction.CustomerDataAction
	(*DeleteChatAction)(nil),                                             // 56: WAWebProtobufSyncAction.DeleteChatAction
	(*DeleteIndividualCallLogAction)(nil),                                // 57: WAWebProtobufSyncAction.DeleteIndividualCallLogAction
	(*DeleteMessageForMeAction)(nil),                                     // 58: WAWebProtobufSyncAction.DeleteMessageForMeAction
	(*DetectedOutcomesStatusAction)(nil),                                 // 59: WAWebProtobufSyncAction.DetectedOutcomesStatusAction
	(*ExternalWebBetaAction)(nil),                                        // 60: WAWebProtobufSyncAction.ExternalWebBetaAction
	(*FavoritesAction)(nil),                                              // 61: WAWebProtobufSyncAction.FavoritesAction
	(*InteractiveMessageAction)(nil),                                     // 62: WAWebProtobufSyncAction.InteractiveMessageAction
	(*KeyExpiration)(nil),                                                // 63: WAWebProtobufSyncAction.KeyExpiration
	(*LabelAssociationAction)(nil),                                       // 64: WAWebProtobufSyncAction.LabelAssociationAction
	(*LabelEditAction)(nil),                                              // 65: WAWebProtobufSyncAction.LabelEditAction
	(*LabelReorderingAction)(nil),                                        // 66: WAWebProtobufSyncAction.LabelReorderingAction
	(*LabelSublistAction)(nil),                                           // 67: WAWebProtobufSyncAction.LabelSublistAction
	(*LidContactAction)(nil),                                             // 68: WAWebProtobufSyncAction.LidContactAction
	(*LocaleSetting)(nil),                                                // 69: WAWebProtobufSyncAction.LocaleSetting
	(*LockChatAction)(nil),                                               // 70: WAWebProtobufSyncAction.LockChatAction
	(*MaibaAIFeaturesControlAction)(nil),                                 // 71: WAWebProtobufSyncAction.MaibaAIFeaturesControlAction
	(*MarkChatAsReadAction)(nil),                                         // 72: WAWebProtobufSyncAction.MarkChatAsReadAction
	(*MarketingMessageAction)(nil),                                       // 73: WAWebProtobufSyncAction.MarketingMessageAction
	(*MarketingMessageBroadcastAction)(nil),                              // 74: WAWebProtobufSyncAction.MarketingMessageBroadcastAction
	(*MerchantPaymentPartnerAction)(nil),                                 // 75: WAWebProtobufSyncAction.MerchantPaymentPartnerAction
	(*MusicUserIdAction)(nil),                                            // 76: WAWebProtobufSyncAction.MusicUserIdAction
	(*MuteAction)(nil),                                                   // 77: WAWebProtobufSyncAction.MuteAction
	(*NctSaltSyncAction)(nil),                                            // 78: WAWebProtobufSyncAction.NctSaltSyncAction
	(*NewsletterSavedInterestsAction)(nil),                               // 79: WAWebProtobufSyncAction.NewsletterSavedInterestsAction
	(*NoteEditAction)(nil),                                               // 80: WAWebProtobufSyncAction.NoteEditAction
	(*NotificationActivitySettingAction)(nil),                            // 81: WAWebProtobufSyncAction.NotificationActivitySettingAction
	(*NuxAction)(nil),                                                    // 82: WAWebProtobufSyncAction.NuxAction
	(*OutContactAction)(nil),                                             // 83: WAWebProtobufSyncAction.OutContactAction
	(*PatchDebugData)(nil),                                               // 84: WAWebProtobufSyncAction.PatchDebugData
	(*PaymentInfoAction)(nil),                                            // 85: WAWebProtobufSyncAction.PaymentInfoAction
	(*PaymentTosAction)(nil),                                             // 86: WAWebProtobufSyncAction.PaymentTosAction
	(*PinAction)(nil),                                                    // 87: WAWebProtobufSyncAction.PinAction
	(*PnForLidChatAction)(nil),                                           // 88: WAWebProtobufSyncAction.PnForLidChatAction
	(*PrimaryFeature)(nil),                                               // 89: WAWebProtobufSyncAction.PrimaryFeature
	(*PrimaryVersionAction)(nil),                                         // 90: WAWebProtobufSyncAction.PrimaryVersionAction
	(*PrivacySettingChannelsPersonalisedRecommendationAction)(nil),       // 91: WAWebProtobufSyncAction.PrivacySettingChannelsPersonalisedRecommendationAction
	(*PrivacySettingDisableLinkPreviewsAction)(nil),                      // 92: WAWebProtobufSyncAction.PrivacySettingDisableLinkPreviewsAction
	(*PrivacySettingRelayAllCalls)(nil),                                  // 93: WAWebProtobufSyncAction.PrivacySettingRelayAllCalls
	(*PrivateProcessingSettingAction)(nil),                               // 94: WAWebProtobufSyncAction.PrivateProcessingSettingAction
	...
	(*RecentEmojiWeight)(nil),                                            // 97: WAWebProtobufSyncAction.RecentEmojiWeight
	(*RecentEmojiWeightsAction)(nil),                                     // 98: WAWebProtobufSyncAction.RecentEmojiWeightsAction
	(*RemoveRecentStickerAction)(nil),                                    // 99: WAWebProtobufSyncAction.RemoveRecentStickerAction
	(*SettingsSyncAction)(nil),                                           // 100: WAWebProtobufSyncAction.SettingsSyncAction
	(*StarAction)(nil),                                                   // 101: WAWebProtobufSyncAction.StarAction
	(*StatusPostOptInNotificationPreferencesAction)(nil),                 // 102: WAWebProtobufSyncAction.StatusPostOptInNotificationPreferencesAction
	(*StatusPrivacyAction)(nil),                                          // 103: WAWebProtobufSyncAction.StatusPrivacyAction
	(*StickerAction)(nil),                                                // 104: WAWebProtobufSyncAction.StickerAction
	(*SubscriptionAction)(nil),                                           // 105: WAWebProtobufSyncAction.SubscriptionAction
	(*SubscriptionsSyncV2Action)(nil),                                    // 106: WAWebProtobufSyncAction.SubscriptionsSyncV2Action
	(*SyncActionData)(nil),                                               // 107: WAWebProtobufSyncAction.SyncActionData
	(*SyncActionMessage)(nil),                                            // 108: WAWebProtobufSyncAction.SyncActionMessage
	(*SyncActionMessageRange)(nil),                                       // 109: WAWebProtobufSyncAction.SyncActionMessageRange
	(*SyncActionValue)(nil),                                              // 110: WAWebProtobufSyncAction.SyncActionValue
	(*ThreadPinAction)(nil),                                              // 111: WAWebProtobufSyncAction.ThreadPinAction
	(*TimeFormatAction)(nil),                                             // 112: WAWebProtobufSyncAction.TimeFormatAction
	(*UGCBot)(nil),                                                       // 113: WAWebProtobufSyncAction.UGCBot
	(*UnarchiveChatsSetting)(nil),                                        // 114: WAWebProtobufSyncAction.UnarchiveChatsSetting
	(*UserStatusMuteAction)(nil),                                         // 115: WAWebProtobufSyncAction.UserStatusMuteAction
	(*UsernameChatStartModeAction)(nil),                                  // 116: WAWebProtobufSyncAction.UsernameChatStartModeAction
	(*WASARootSecretAction)(nil),                                         // 117: WAWebProtobufSyncAction.WASARootSecretAction
...
var file_waSyncAction_WAWebProtobufSyncAction_proto_depIdxs = []int32{
	...
	104, // 2: WAWebProtobufSyncAction.AvatarUpdatedAction.recentAvatarStickers:type_name -> WAWebProtobufSyncAction.StickerAction
	...
	38,  // 6: WAWebProtobufSyncAction.BusinessBroadcastListAction.participants:type_name -> WAWebProtobufSyncAction.BroadcastListParticipant
	45,  // 7: WAWebProtobufSyncAction.CallLogAction.callLogRecord:type_name -> WAWebProtobufSyncAction.CallLogRecord
	...
	120, // 10: WAWebProtobufSyncAction.CallLogRecord.participants:type_name -> WAWebProtobufSyncAction.CallLogRecord.ParticipantInfo
	5,   // 11: WAWebProtobufSyncAction.CallLogRecord.callType:type_name -> WAWebProtobufSyncAction.CallLogRecord.CallType
	109, // 12: WAWebProtobufSyncAction.ClearChatAction.messageRange:type_name -> WAWebProtobufSyncAction.SyncActionMessageRange
	...
	97,  // 30: WAWebProtobufSyncAction.RecentEmojiWeightsAction.weights:type_name -> WAWebProtobufSyncAction.RecentEmojiWeight
	...
	77,  // 44: WAWebProtobufSyncAction.SyncActionValue.muteAction:type_name -> WAWebProtobufSyncAction.MuteAction
	87,  // 45: WAWebProtobufSyncAction.SyncActionValue.pinAction:type_name -> WAWebProtobufSyncAction.PinAction
	95,  // 46: WAWebProtobufSyncAction.SyncActionValue.pushNameSetting:type_name -> WAWebProtobufSyncAction.PushNameSetting
	96,  // 47: WAWebProtobufSyncAction.SyncActionValue.quickReplyAction:type_name -> WAWebProtobufSyncAction.QuickReplyAction
	98,  // 48: WAWebProtobufSyncAction.SyncActionValue.recentEmojiWeightsAction:type_name -> WAWebProtobufSyncAction.RecentEmojiWeightsAction
	65,  // 49: WAWebProtobufSyncAction.SyncActionValue.labelEditAction:type_name -> WAWebProtobufSyncAction.LabelEditAction
	64,  // 50: WAWebProtobufSyncAction.SyncActionValue.labelAssociationAction:type_name -> WAWebProtobufSyncAction.LabelAssociationAction
	69,  // 51: WAWebProtobufSyncAction.SyncActionValue.localeSetting:type_name -> WAWebProtobufSyncAction.LocaleSetting
	33,  // 52: WAWebProtobufSyncAction.SyncActionValue.archiveChatAction:type_name -> WAWebProtobufSyncAction.ArchiveChatAction
	58,  // 53: WAWebProtobufSyncAction.SyncActionValue.deleteMessageForMeAction:type_name -> WAWebProtobufSyncAction.DeleteMessageForMeAction
	63,  // 54: WAWebProtobufSyncAction.SyncActionValue.keyExpiration:type_name -> WAWebProtobufSyncAction.KeyExpiration
	72,  // 55: WAWebProtobufSyncAction.SyncActionValue.markChatAsReadAction:type_name -> WAWebProtobufSyncAction.MarkChatAsReadAction
	48,  // 56: WAWebProtobufSyncAction.SyncActionValue.clearChatAction:type_name -> WAWebProtobufSyncAction.ClearChatAction
	56,  // 57: WAWebProtobufSyncAction.SyncActionValue.deleteChatAction:type_name -> WAWebProtobufSyncAction.DeleteChatAction
	114, // 58: WAWebProtobufSyncAction.SyncActionValue.unarchiveChatsSetting:type_name -> WAWebProtobufSyncAction.UnarchiveChatsSetting
	89,  // 59: WAWebProtobufSyncAction.SyncActionValue.primaryFeature:type_name -> WAWebProtobufSyncAction.PrimaryFeature
	32,  // 60: WAWebProtobufSyncAction.SyncActionValue.androidUnsupportedActions:type_name -> WAWebProtobufSyncAction.AndroidUnsupportedActions
	30,  // 61: WAWebProtobufSyncAction.SyncActionValue.agentAction:type_name -> WAWebProtobufSyncAction.AgentAction
	105, // 62: WAWebProtobufSyncAction.SyncActionValue.subscriptionAction:type_name -> WAWebProtobufSyncAction.SubscriptionAction
	115, // 63: WAWebProtobufSyncAction.SyncActionValue.userStatusMuteAction:type_name -> WAWebProtobufSyncAction.UserStatusMuteAction
	112, // 64: WAWebProtobufSyncAction.SyncActionValue.timeFormatAction:type_name -> WAWebProtobufSyncAction.TimeFormatAction
	82,  // 65: WAWebProtobufSyncAction.SyncActionValue.nuxAction:type_name -> WAWebProtobufSyncAction.NuxAction
	90,  // 66: WAWebProtobufSyncAction.SyncActionValue.primaryVersionAction:type_name -> WAWebProtobufSyncAction.PrimaryVersionAction
	104, // 67: WAWebProtobufSyncAction.SyncActionValue.stickerAction:type_name -> WAWebProtobufSyncAction.StickerAction
	99,  // 68: WAWebProtobufSyncAction.SyncActionValue.removeRecentStickerAction:type_name -> WAWebProtobufSyncAction.RemoveRecentStickerAction
	46,  // 69: WAWebProtobufSyncAction.SyncActionValue.chatAssignment:type_name -> WAWebProtobufSyncAction.ChatAssignmentAction
	47,  // 70: WAWebProtobufSyncAction.SyncActionValue.chatAssignmentOpenedStatus:type_name -> WAWebProtobufSyncAction.ChatAssignmentOpenedStatusAction
	88,  // 71: WAWebProtobufSyncAction.SyncActionValue.pnForLidChatAction:type_name -> WAWebProtobufSyncAction.PnForLidChatAction
	73,  // 72: WAWebProtobufSyncAction.SyncActionValue.marketingMessageAction:type_name -> WAWebProtobufSyncAction.MarketingMessageAction
	74,  // 73: WAWebProtobufSyncAction.SyncActionValue.marketingMessageBroadcastAction:type_name -> WAWebProtobufSyncAction.MarketingMessageBroadcastAction
	60,  // 74: WAWebProtobufSyncAction.SyncActionValue.externalWebBetaAction:type_name -> WAWebProtobufSyncAction.ExternalWebBetaAction
	93,  // 75: WAWebProtobufSyncAction.SyncActionValue.privacySettingRelayAllCalls:type_name -> WAWebProtobufSyncAction.PrivacySettingRelayAllCalls
	44,  // 76: WAWebProtobufSyncAction.SyncActionValue.callLogAction:type_name -> WAWebProtobufSyncAction.CallLogAction
	113, // 77: WAWebProtobufSyncAction.SyncActionValue.ugcBot:type_name -> WAWebProtobufSyncAction.UGCBot
	103, // 78: WAWebProtobufSyncAction.SyncActionValue.statusPrivacy:type_name -> WAWebProtobufSyncAction.StatusPrivacyAction
	37,  // 79: WAWebProtobufSyncAction.SyncActionValue.botWelcomeRequestAction:type_name -> WAWebProtobufSyncAction.BotWelcomeRequestAction
	57,  // 80: WAWebProtobufSyncAction.SyncActionValue.deleteIndividualCallLog:type_name -> WAWebProtobufSyncAction.DeleteIndividualCallLogAction
	66,  // 81: WAWebProtobufSyncAction.SyncActionValue.labelReorderingAction:type_name -> WAWebProtobufSyncAction.LabelReorderingAction
	...
	118, // 92: WAWebProtobufSyncAction.SyncActionValue.waffleAccountLinkStateAction:type_name -> WAWebProtobufSyncAction.WaffleAccountLinkStateAction
	116, // 93: WAWebProtobufSyncAction.SyncActionValue.usernameChatStartMode:type_name -> WAWebProtobufSyncAction.UsernameChatStartModeAction
	81,  // 94: WAWebProtobufSyncAction.SyncActionValue.notificationActivitySettingAction:type_name -> WAWebProtobufSyncAction.NotificationActivitySettingAction
	68,  // 95: WAWebProtobufSyncAction.SyncActionValue.lidContactAction:type_name -> WAWebProtobufSyncAction.LidContactAction
	51,  // 96: WAWebProtobufSyncAction.SyncActionValue.ctwaPerCustomerDataSharingAction:type_name -> WAWebProtobufSyncAction.CtwaPerCustomerDataSharingAction
	86,  // 97: WAWebProtobufSyncAction.SyncActionValue.paymentTosAction:type_name -> WAWebProtobufSyncAction.PaymentTosAction
	91,  // 98: WAWebProtobufSyncAction.SyncActionValue.privacySettingChannelsPersonalisedRecommendationAction:type_name -> WAWebProtobufSyncAction.PrivacySettingChannelsPersonalisedRecommendationAction
	59,  // 99: WAWebProtobufSyncAction.SyncActionValue.detectedOutcomesStatusAction:type_name -> WAWebProtobufSyncAction.DetectedOutcomesStatusAction
	71,  // 100: WAWebProtobufSyncAction.SyncActionValue.maibaAiFeaturesControlAction:type_name -> WAWebProtobufSyncAction.MaibaAIFeaturesControlAction
	43,  // 101: WAWebProtobufSyncAction.SyncActionValue.businessBroadcastListAction:type_name -> WAWebProtobufSyncAction.BusinessBroadcastListAction
	76,  // 102: WAWebProtobufSyncAction.SyncActionValue.musicUserIDAction:type_name -> WAWebProtobufSyncAction.MusicUserIdAction
	102, // 103: WAWebProtobufSyncAction.SyncActionValue.statusPostOptInNotificationPreferencesAction:type_name -> WAWebProtobufSyncAction.StatusPostOptInNotificationPreferencesAction
	35,  // 104: WAWebProtobufSyncAction.SyncActionValue.avatarUpdatedAction:type_name -> WAWebProtobufSyncAction.AvatarUpdatedAction
	94,  // 105: WAWebProtobufSyncAction.SyncActionValue.privateProcessingSettingAction:type_name -> WAWebProtobufSyncAction.PrivateProcessingSettingAction
	79,  // 106: WAWebProtobufSyncAction.SyncActionValue.newsletterSavedInterestsAction:type_name -> WAWebProtobufSyncAction.NewsletterSavedInterestsAction
	31,  // 107: WAWebProtobufSyncAction.SyncActionValue.aiThreadRenameAction:type_name -> WAWebProtobufSyncAction.AiThreadRenameAction
	62,  // 108: WAWebProtobufSyncAction.SyncActionValue.interactiveMessageAction:type_name -> WAWebProtobufSyncAction.InteractiveMessageAction
	100, // 109: WAWebProtobufSyncAction.SyncActionValue.settingsSyncAction:type_name -> WAWebProtobufSyncAction.SettingsSyncAction
	83,  // 110: WAWebProtobufSyncAction.SyncActionValue.outContactAction:type_name -> WAWebProtobufSyncAction.OutContactAction
	78,  // 111: WAWebProtobufSyncAction.SyncActionValue.nctSaltSyncAction:type_name -> WAWebProtobufSyncAction.NctSaltSyncAction
	41,  // 112: WAWebProtobufSyncAction.SyncActionValue.businessBroadcastCampaignAction:type_name -> WAWebProtobufSyncAction.BusinessBroadcastCampaignAction
	42,  // 113: WAWebProtobufSyncAction.SyncActionValue.businessBroadcastInsightsAction:type_name -> WAWebProtobufSyncAction.BusinessBroadcastInsightsAction
	55,  // 114: WAWebProtobufSyncAction.SyncActionValue.customerDataAction:type_name -> WAWebProtobufSyncAction.CustomerDataAction
	106, // 115: WAWebProtobufSyncAction.SyncActionValue.subscriptionsSyncV2Action:type_name -> WAWebProtobufSyncAction.SubscriptionsSyncV2Action
	111, // 116: WAWebProtobufSyncAction.SyncActionValue.threadPinAction:type_name -> WAWebProtobufSyncAction.ThreadPinAction
	34,  // 117: WAWebProtobufSyncAction.SyncActionValue.autoOrganizeBusinessChatSetting:type_name -> WAWebProtobufSyncAction.AutoOrganizeBusinessChatSetting
	36,  // 118: WAWebProtobufSyncAction.SyncActionValue.bizAiSettingsNudgeAction:type_name -> WAWebProtobufSyncAction.BizAISettingsNudgeAction
	49,  // 119: WAWebProtobufSyncAction.SyncActionValue.coexV2VersionAction:type_name -> WAWebProtobufSyncAction.CoexV2VersionAction
