...
func (Command_CommandType) EnumDescriptor() ([]byte, []int) {
	return file_waCommonParameterised_WACommonParameterised_proto_rawDescGZIP(), []int{0, 0}
}
...
const file_waCommonParameterised_WACommonParameterised_proto_rawDesc = "" +
	"\n" +
	"1waCommonParameterised/WACommonParameterised.proto\x12\x15WACommonParameterised\"\xf2\x01\n" +
	"\aCommand\x12L\n" +
	...
	"\vparticipant\x18\x04 \x01(\tR\vparticipant\"\xbd\x01\n" +
...
var file_waCommonParameterised_WACommonParameterised_proto_goTypes = []any{
	...
	(*Command)(nil),          // 3: WACommonParameterised.Command
	(*Mention)(nil),          // 4: WACommonParameterised.Mention
	(*MessageKey)(nil),       // 5: WACommonParameterised.MessageKey
...
var file_waCommonParameterised_WACommonParameterised_proto_depIdxs = []int32{
	...
	3, // 2: WACommonParameterised.MessageText.commands:type_name -> WACommonParameterised.Command
	4, // 3: WACommonParameterised.MessageText.mentions:type_name -> WACommonParameterised.Mention
